                            ...
                            <form class="postForm" action="{{route("admin.blog.store")}}" method="POST" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Blog Başlık">
                                    </div>

                                    <div class="form-group">
                                        <label>Blog Kısa Açıklama</label>
                                        <input type="text" name="short_content" class="form-control" placeholder="Blog Kısa Açıklama">
                                    </div>
