        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Kategori Ekle</span></h4>
        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="postForm" action="{{route("admin.category.store")}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Kategori Başlık" required>
                                    </div>

                                    <div class="form-group">
                                        <label>Kategori Kısa İçerik</label>
                                        <input type="text" name="short_content" class="form-control" placeholder="Kısa İçerik">
                                    </div>
