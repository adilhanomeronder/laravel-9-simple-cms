        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Resim Ekle</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="admin/gallery" class="breadcrumb-item">Resimler</a>
        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="postForm" action="{{route("admin.gallery.store")}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <fieldset>
                                    <div class="form-group">
                                        <label>Resim Başlık</label>
                                        <input type="text" name="title" class="form-control" placeholder="Resim Başlık" required>
                                    </div>

                                    <div class="form-group">
                                        <label>Alan</label>
                                        <select name="area" id="area" class="form-control" required>
                                            <option value="1">Referanslar</option>
