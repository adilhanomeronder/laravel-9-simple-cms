        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">{{$data->title}} hizmeti düzenleniyor...</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="admin/service" class="breadcrumb-item">Ürünler</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="edit">
                                    <form class="postForm" action="{{route("admin.service.update",$data->id)}}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        {{ method_field('PUT') }}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" placeholder="Hizmet Başlık" value="{{$data->title}}">
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pictures">
                                    <div class="form-group">
                                        @if(count($images))
                                            <div id="sortable" class="row" data-url="admin/service/sortable" data-csrf="{{csrf_token()}}">
                                                @foreach($images as $image)
                                                    <div class="card col-3" id="{{$image->id}}">
                                                        <div class="card-img-actions">
                                                            <img class="card-img-top img-fluid" src="{{asset("assets/images/service/".$image->image)}}" alt="">
                                                            <div class="card-img-actions-overlay card-img-top">
                                                                <a href="{{asset("assets/images/service/".$image->image)}}" target="_blank" class="btn btn-outline bg-white text-white border-white border-2" data-popup="lightbox">
                                                                    Önizle
                                                                </a>
                                                                <a href="javascript:void(0)" onclick="postInput('admin/service/deletePicture/', {{$image->id}}, '{{csrf_token()}}')" class="btn btn-outline bg-white text-white border-white border-2 ml-2">
                                                                    Sil
                                                                </a>
                                                            </div>
                                                        </div>
